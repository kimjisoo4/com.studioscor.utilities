...
{
    [UnitTitle("InRangeOrEqual")]
    [UnitCategory("Logic\\StudioScor")]
    public sealed class InRangeOrEqualUnit : Unit
    {
        [DoNotSerialize]
        [PortLabel("A")]
        ...
        {
            return OperatorUtility.LessThanOrEqual(greater, value) && OperatorUtility.GreaterThanOrEqual(value, less);
        }
    }
}
#endif