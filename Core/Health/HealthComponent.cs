...
namespace StudioScor.Utilities
{
    ...
    public class HealthComponent : BaseMonoBehaviour, IDamageable
	{
		public enum ESetup
		{
			Awake,
		...
		public void SetHealthAsRatio(float ratio, bool isNormalized = false)
		{
			float ratioHelath = isNormalized ? Health * ratio : Health * ratio * 0.01f;

			SetHealth(ratioHelath);
		}
